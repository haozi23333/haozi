...
后面打算把系统换掉改成 LINUX装KVM算了.  调研了很多 KVM带Web界面的管理器, 最后找到了 [UNRAID](https://unraid.net) 这个系统(突然想起在 LinusTechTips 的视频里面见过类似的)
...
![UNRAID](./unraid初体验/unraid_array.png)
...
![UNRAID](./unraid初体验/unraid_home.png)

其中每一个Share可以分配这4种不同的方式来进行访问, NFS对linux, AFP对 apple等

![UNRAID](./unraid初体验/unraid_share_network.png)
...
参见 [Unraid 购买授权](./unraid购买授权.md)

如果想看到更多的关于 UNRAID  的文章， 点击 [UNRAID 分类把](/tags/unraid)
import Link from '@docusaurus/Link';

<Link to='/tags/unarid'> UNRAID 分类把</Link>
## ~
